...
The DBM class provides a wrapper to a Unix-style [dbm][1] or Database
Manager library.
...
* [Berkeley DB][2] versions 1 thru 5, also known as BDB and Sleepycat
  DB, now owned by Oracle Corporation.

* Berkeley DB 1.x, still found in 4.4BSD derivatives (FreeBSD, OpenBSD,
  etc).

* [gdbm][3], the GNU implementation of dbm.
* [qdbm][4], another open source reimplementation of dbm.
...
[4]: http://fallabs.com/qdbm/index.html
...
1: [IEEE Std 1003.1-2008, 2016 Edition, the Shell & Utilities volume][1]
